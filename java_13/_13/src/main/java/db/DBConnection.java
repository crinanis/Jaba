...
public class DBConnection {
    ...
    public Connection GetConnection() throws SQLException {
        try {
            ...
            connection = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/lab9?serverTimezone=Europe/Moscow&useSSL=false",
                                                                    "root", "Ksusha20031007");
    ...
    public boolean AddUser(users user) throws SQLException {
        ...
        String select="insert into users(username,password,role) values('"+user.getUsername() +"','"+user.getPassword()+ "','user');";
